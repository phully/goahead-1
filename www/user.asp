...
<!--you code start-->
		<form action=/goform/user method="post" name="user">
	      ...
	      <tr>
	        <td  colspan="9"  align="center" class="biao" >用户信息</td>
	      </tr>
	      <tr align="center" class="toprow">
	       <td align="center" class="lefttd">用户名</td>
	       <td align="center" class="midtd">所属用户组</td>
	       <td align="center" class="midtd">用户状态</td>
	       <td align="center" class="righttd" colspan="2">操作</td> 
	      </tr>
	      <% MakeUserList(); %>
	    
		    <tr>
		    <td align="center" height="40"  class="lefttd" colspan=9>
		    <input type="button" value="创建用户" class="aniu" onclick="AddUser()" />&nbsp;&nbsp;
		    <input type="button" value="修改密码" class="aniu" onclick="ModifyPass();" />
