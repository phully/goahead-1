...
<script>	
	...
	function judgemin()     //码流的相关数据保存
	{
		if(checkmin_rate_time())
		{
		 var judgeValue=document.getElementById("text_judge").value=1;
		 setMinEncode();
	  }
	}
	...
	function judgeFrame_rateEncode()  //帧率
	{
		var judgeValue=document.getElementById("text_judge").value=1;
		setFrame_rateEncode();
	}
			...
			<fieldset>
		    	...
		    	<table>	
		    	 <tr>		
				  ...
				  <td>
				  	<input type="button"   value="应用" onclick="setframe_rate_time()"/>		
				  </td>
				</tr>
				<tr>
	  				<td><span>帧率:</span></td>
				...
				<tr>
				 ...
				 <td>
				 	<div style="display:none">
							<input id="text_judge" type="text" size="1">
					</div>
				 </td>			  			  		  
				 </tr>
				 <tr>
