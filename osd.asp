  			...
  			<p class="sidebtn"></p>
				...
				<table>
						<tr>
							...
							<td align="left"><input id="s1_text1_size" type="text" size="4"/></td>		
						</tr>
						<tr>
  			...
  			<p class="sidebtn"></p>
				...
				<table>
						<tr>
							...
							<td align="center"><span>&nbsp;&nbsp;&nbsp;字体大小:</span></td>
							<td align="left"><input id="s1_text2_size" type="text" size="4"/></td>
  			...
  			<p class="sidebtn"></p>
				...
				<table>
						<tr>
							...
							<td align="center"><span>&nbsp;&nbsp;&nbsp;字体大小:</span></td>
							<td align="left"><input id="s1_text3_size" type="text" size="4"/></td>
